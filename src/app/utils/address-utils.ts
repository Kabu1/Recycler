...
export function findNeighbourhood(addressComponents: {long_name: string, short_name: string, types: string[]}[]): string {
    return findAddressComponent(addressComponents, 'sublocality') ||  findAddressComponent(addressComponents, 'sublocality_level_1')
}
